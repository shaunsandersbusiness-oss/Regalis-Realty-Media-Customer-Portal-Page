...
export default function Navbar() {
  useEffect(() => {
    ...
    const activeLink = document.querySelector('.nav-link[data-page="portal"]');
    if (activeLink) {
      ...
      <nav className="regalis-nav" id="regalisNav">
        <div className="nav-inner">
          ...
          <div className="nav-links" id="navLinks">
            ...
            <a href="https://regalisrealtymedia25.pixieset.com/regalisrealtymediaportfolio/compassphotos/" className="nav-link" data-page="portfolio" target="_blank" rel="noopener noreferrer">Portfolio</a>
